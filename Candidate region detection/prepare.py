...
#     resolution = np.array([2,2,2])
    ...
    if isClean:
        ...
        # 打印检查
        print(f"sliceim1.shape: {sliceim1.shape}, extendbox: {extendbox}")
        sliceim2 = sliceim1[extendbox[0,0]:extendbox[0,1],
                    extendbox[1,0]:extendbox[1,1],
                    extendbox[2,0]:extendbox[2,1]]
        print(f"sliceim2.shape: {sliceim2.shape}, extendbox: {extendbox}")
...
def preprocess_luna():
    ...
    finished_flag = '.flag_preprocessluna11'
...
def prepare_luna():
    ...
    luna_data = config['luna_data']
    luna_segment = config['luna_segment']
    finished_flag = '.flag_prepareluna111'
